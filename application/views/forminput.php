...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">WebTU</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <h6 class="dropdown-header">Penambahan Data:</h6>
            <a class="dropdown-item" href="FormInput.php">Data Siswa</a>
            <a class="dropdown-item" href="forminputlks.php">LKS</a>
            <a class="dropdown-item" href="forminputpaket.php">Buku Paket</a>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <table>
<FORM ACTION ="cek_indatasiswa.php" METHOD="POST">
              <tr>
                <td>NIS</td>
              ...
              <tr>
                <td>Telepon Wali</td>
                <td>: <input type ="text" name="telepon_wali"></td>
              </tr>
              <tr>
